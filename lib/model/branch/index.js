...
function Branch(data) {
  ...
  if (this.isBranch) {
    var _propagateEvent = this.parent.emit.bind(this.parent);

    // propagate events to parents
    this.on('node-added', _propagateEvent.bind(null, 'node-added'));
    this.on('node-removed', _propagateEvent.bind(null, 'node-removed'));
    this.on('node-moved', _propagateEvent.bind(null, 'node-moved'));
  }
