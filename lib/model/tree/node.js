...
/**
 * Traverses the tree up to the root node.
 * @param  {Function} fn Function to be called with each node
 * @return {undefined}
 */
Node.prototype.traverseAncestors = function (fn) {
  var _currentNode = this;
