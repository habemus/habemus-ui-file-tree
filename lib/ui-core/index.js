...
Happiness.prototype.addBranch = function (nodeModel, index) {
  ...
  setTimeout(function () {
    branchElement.classList.add(this.ENTER);
  }.bind(this), 0);
...
Happiness.prototype.addLeaf = function (nodeModel, index) {
  ...
  setTimeout(function () {
    leafElement.classList.add(this.ENTER);
  }.bind(this), 0);
...
Happiness.prototype.removeNode = function (role, path) {
  var el = this.getElement(role, path);
...
Happiness.prototype._branchEl = function (nodeData) {
  var el = nodeData.isRoot ?
    this.$rootEl(nodeData) : this.$branchEl(nodeData);
