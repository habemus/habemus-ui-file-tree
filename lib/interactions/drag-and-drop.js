...
module.exports = function (rootModel, ui) {
  ...
  // ui.addTreeEventListener('dragend', 'branch', function (data) {
  //   // console.log('dragend on branch', data.element, data.path);
  //   data.element.classList.remove(ui.DRAGGING);
  // });
  
  ui.rootElement.addEventListener('dragend', function (e) {
