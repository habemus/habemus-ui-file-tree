...
// constants
const HAPPINESS_TREE_DND_FORMAT_NAME = 'text/x-habemus-ui-file-tree';
...
module.exports = function (happinessTree, rootModel, uiCore, options) {
   ...
   * Dragover
   *
   * The dragover may refer to 'habemus-ui-file-tree' dragover (node-dragging)
        ...
        closestBranchModel.fsRead()
          ...
          .catch(function (err) {
            ...
            happinessTree.uiNotifications.error.show({
              text: _t('habemus-ui-file-tree.directory.error-reading', {
    ...
    function (data) {
      ...
      if (closestBranchModel.hasAncestor(draggedNode) || closestBranchModel === draggedNode) {
        ...
        var loadingMessage = draggedNode.isBranch ?
          _t('habemus-ui-file-tree.directory.move-loading') :
          _t('habemus-ui-file-tree.file.move-loading');
        ...
        rootModel.fsMove(draggedNode, closestBranchModel)
          ...
          .catch(function (err) {
            ...
            var errorMessage = draggedNode.isBranch ?
              _t('habemus-ui-file-tree.directory.error-moving', {
                directoryName: draggedNodePath,
              }) :
              _t('habemus-ui-file-tree.file.error-moving', {
  ...
  uiCore.addTreeEventListener(
    ...
    function (data) {
      ...
      happinessTree.upload.fromDropEvent(closestBranchModel.path, data.event)
        .then(function () {
