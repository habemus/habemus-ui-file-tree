      ...
      callback: function (data) {
        ...
        happinessTree.openDirectory(nodeModel.path)
          .then(function () {
            ...
            var newFilePlacehodler = uiCore._leafEl({
              name: happinessTree.translate('happiness-tree.new-file-placeholder')
            });
      ...
      callback: function (data) {
        ...
        happinessTree.openDirectory(nodeModel.path)
          .then(function () {
            ...
            var newFilePlacehodler = uiCore._branchEl({
              name: happinessTree.translate('happiness-tree.new-folder-placeholder')
            });
            newFilePlacehodler.classList.add(uiCore.ENTER);
            var editableLabel = newFilePlacehodler.querySelector('hab-editable-label');
