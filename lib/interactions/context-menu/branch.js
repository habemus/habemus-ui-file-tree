        ...
        happinessTree.openDirectory(nodeModel.path)
          .then(function () {
            ...
            var placeholder = uiCore.addEditablePlaceholder({
              ...
              value: _t('happiness-tree.file.new-placeholder')
            });
            ...
            placeholder.edit(function (value) {
              ...
              // cancel
              if (value === '') {
                uiDialogs.alert(_t('happiness-tree.file.new-error.empty-name'));
                placeholder.remove();
                return;
              }
              ...
              uiNotifications.loading.show({
                text: _t('happiness-tree.file.new-loading'),
              ...
              nodeModel.fsCreateFile(value)
                ...
                .catch(function (err) {
                  uiNotifications.loading.hide();
                  uiDialogs.alert(_t('happiness-tree.file.new-error.general'));
                  console.warn(err);
                });
            });
          });
        ...
        happinessTree.openDirectory(nodeModel.path)
          .then(function () {
            ...
            var placeholder = uiCore.addEditablePlaceholder({
              type: 'branch',
              directoryPath: nodeModel.path,
              value: _t('happiness-tree.directory.new-placeholder')
            });

            placeholder.edit(function (value) {
              if (value === '') {
                uiDialogs.alert(_t('happiness-tree.directory.new-error.empty-name'));
                placeholder.remove();
                return;
              }
              ...
              uiNotifications.loading.show({
                text: _t('happiness-tree.directory.new-loading'),
                duration: Math.Infinity,
              });
              ...
              nodeModel.fsCreateDirectory(value)          
                ...
                .catch(function (err) {
                  uiNotifications.loading.hide();
                  uiDialogs.alert(_t('happiness-tree.directory.new-error.general'));
                  console.warn(err);
                });
            })
          });
