...
function HappinessTree(options) {
   ...
   * Load interactions
   */
  require('./interactions/drag-and-drop')(this, rootModel, uiCore);
  require('./interactions/click')(this, rootModel, uiCore);
  require('./interactions/context-menu')(this, rootModel, uiCore);
}
