  ...
  return this.openDirectory(nodeModel.path)
    .then(function () {
      ...
      var placeholder = self.uiCore.addEditablePlaceholder({
        ...
        value: self.translate('happiness-tree.file.new-placeholder')
      });
      ...
      placeholder.edit(function (value) {
        ...
        // cancel
        if (value === '') {
          self.uiDialogs.alert(self.translate('happiness-tree.file.new-error.empty-name'));
          placeholder.remove();
          return;
        }
        ...
        self.uiNotifications.loading.show({
          text: self.translate('happiness-tree.file.new-loading'),
        ...
        nodeModel.fsCreateFile(value)
          ...
          .catch(function (err) {
            self.uiNotifications.loading.hide();
            self.uiDialogs.alert(self.translate('happiness-tree.file.new-error.general'));
            console.warn(err);
          });
      });
    });
  ...
  return this.openDirectory(nodeModel.path)
    .then(function () {
      ...
      var placeholder = self.uiCore.addEditablePlaceholder({
        type: 'branch',
        directoryPath: nodeModel.path,
        value: self.translate('happiness-tree.directory.new-placeholder')
      });

      placeholder.edit(function (value) {
        if (value === '') {
          self.uiDialogs.alert(self.translate('happiness-tree.directory.new-error.empty-name'));
          placeholder.remove();
          return;
        }
        ...
        self.uiNotifications.loading.show({
          text: self.translate('happiness-tree.directory.new-loading'),
          duration: Math.Infinity,
        });
        ...
        nodeModel.fsCreateDirectory(value)          
          ...
          .catch(function (err) {
            self.uiNotifications.loading.hide();
            self.uiDialogs.alert(self.translate('happiness-tree.directory.new-error.general'));
            console.warn(err);
          });
      })
    });
